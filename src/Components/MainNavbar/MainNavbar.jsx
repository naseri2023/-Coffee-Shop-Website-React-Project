...
function MainNavbar(props) {
    ...
    // نمایش و عدم نمایش منو موبایل با ضربدر و همبرگری
    const [open, setOpen] = useState(false);
    // نمایش و عدم نمایش زیر منو
    const [show, setShow] = useState(false);
    // نمایش و عدم نمایش کارت خرید
    const [cart, setCart] = useState(false);
    // اکتیو کردن منو ها با تغییر در index.css
    const [activeLink, setActiveLink] = useState("قهوه");
    ...
    return (<>
        ...
        w-[98%] lg:w-[90%] pr-10 px-10 h-24 mx-auto rounded-3xl backdrop-blur-[6px]">
            <div className="flex w-full justify-between items-center">
                ...
                <nav className="flex gap-x-6 lg:gap-x-9 items-center h-14">
                    ...
                    <ul className="flex gap-x-5 lg:gap-x-9 tracking-tightest text-xl text-gray-300 h-full child:leading-[56px]">
                ...
                <div className="flex items-center gap-x-4 lg:gap-x-5 xl:gap-x-10 text-orange-200">
                    ...
                    <div className="flex gap-x-4 lg:gap-x-5 items-center">
                        ...
                        <div className="relative group">
                            ...
                            {/*Cart Box*/}
                            <div className="absolute left-0 top-full opacity-0 invisible group-hover:opacity-100 group-hover:visible w-[400px] p-5 bg-white dark:bg-zinc-700 border-t-[3px] border-t-orange-300 rounded-2xl shadow-normal transition-all delay-75">
                                {/*Cart Header*/}
                            ...
                            {/*Cart Body*/}
                                <div className="divide-y divide-gray-100 dark:divide-white/10 border-b border-b-gray-300 dark:border-b-white/10 child:py-5 pb-1 ">

                                    <div className="flex gap-x-2.5 ">
                                    <img className="w-[120px] h-[120px]" src="/assets/images/products/p1.png" alt="product 1" />
                                    <div className="flex flex-col justify-between">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-zinc-700 dark:text-white tracking-tighter font-DanaBold">
                                                175,000
                                                <span className="font-DanaLight text-sm pr-1">تومان</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    <div className="flex gap-x-2.5 ">
                                        <img className="w-[120px] h-[120px]" src="/assets/images/products/p2.png" alt="product 1" />
                                        <div className="flex flex-col justify-between">
                                            <h4 className="font-DanaMedium text-zinc-700 dark:text-white text-base line-clamp-2">قهوه اسپرسو بن مانو مدل پریسکا                               250                              گرمی</h4>
                                            <div>
                                                <span className="text-teal-600 dark:text-emerald-500 text-xs tracking-tighter">14.500 تومان تخفیف</span>
                            ...
                            {/*Cart Footer*/}
                                <div className="flex justify-between items-center pt-5">
                                    <div className="flex flex-col justify-between ">
                                        ...
                                        <div className="flex items-center justify-between text-zinc-700 dark:text-white tracking-tighter font-DanaBold">
                                            350,000
                                            <span className="font-DanaLight text-sm flex pr-1">تومان</span>
                                        </div>
                                    </div>
                                    <div >
                        ...
                        {/*Theme Switch Btn*/}
                        <div className="w-6 h-6 cursor-pointer" onClick={themeHandler} >
                                {themes[theme].logo}
                        </div>
                    </div>
                    {/*Divide Border*/}
        ...
        <div
            ...
            `}>
                ...
                {/*Body Menu*/}
                <ul className="space-y-6 child:pr-2.5 text-zinc-600 dark:text-white ">
                    <li className=" flex items-center gap-x-2 text-orange-300 bg-orange-200/20 h-10 rounded-md">
                    ...
                    <li className="relative group" >
                        <a onClick={subMenuHandler}
                           href="/"
                           className={`transition-colors flex items-center justify-between gap-x-2 ${open ? "text-orange-300" : "text-zinc-600 dark:text-white "} `}>
                        ...
                        {/*sub menu*/}
                        <ul className={`space-y-6 text-zinc-600 dark:text-white text-sm pt-5 pr-7
                        ${
                            show ? "opacity-100 visible" : "hidden" 
                        }`}
                        >
                            <li>
                                <a
                    ...
                    <div className={` ${open ? "space-y-6" : "space-y-6"} `}>
                        <li>
                ...
                <div className="text-orange-300 space-y-6 px-2.5 py-8 mt-8 border-t border-t-gray-100 dark:border-t-white/10">
                    ...
                    <span className="flex items-center gap-x-2">
                        <div className="w-5 h-5 cursor-pointer" onClick={themeHandler} >
                                {themes[theme].logo}
                        </div>
            ...
            <div
                ...
                `}>
                    ...
                    <div className="flex justify-between items-center pb-5 mb-5 border-b border-b-gray-300 dark:border-b-white/10">
                        ...
                        <span className="text-zinc-700 dark:text-white font-DanaLight text-sm">
                            سبد خرید
                        </span>
                    </div>
                        {/*Cart Body*/}
                        <div className="divide-y divide-gray-100 dark:divide-white/10 border-b border-b-gray-300 dark:border-b-white/10 child:py-5 pb-1 ">
                            ...
                            <div className="flex gap-x-1 ">
                                <img className="w-[90px] h-[90px]" src="/assets/images/products/p1.png" alt="product 1" />
                                <div className="flex flex-col justify-between gap-y-1.5">
                                    <h4 className="font-DanaLight text-zinc-700 dark:text-white text-sm line-clamp-2">قهوه اسپرسو بن مانو مدل پریسکا                               250                              گرمی</h4>
                                    <div>
                                        <span className="font-DanaLight text-teal-600 dark:text-emerald-500 text-xs">14.500 تومان تخفیف</span>
                                        <div className="text-zinc-700 dark:text-white tracking-tighter font-DanaMedium">
                                            175,000
                                            <span className="font-DanaLight text-xs pr-1">تومان</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="fixed bottom-0 flex justify-between items-center pb-8 gap-x-4">
                            ...
                            <div className="flex flex-col justify-between ">
                                <span className="text-gray-300 font-DanaLight text-xs pb-1">مبلغ قابل پرداخت</span>
                                <div className="flex items-center justify-between text-zinc-700 dark:text-white tracking-tighter font-DanaMedium">
                                    350,000
                                    <span className="font-DanaLight text-sm flex pr-1">تومان</span>
                                </div>
                            </div>
            ...
            <div className={`${open || show ? "" : "hidden"} overLay md:hidden fixed inset-0 w-full h-full z-10 bg-black/40 `}></div>
        </>
    );
}
