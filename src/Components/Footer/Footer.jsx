            ...
            <div className="sm:w-[94%] lg:w-[90%] md:px-0 px-4 mx-auto">
                <div className="flex justify-between flex-wrap">
                    ...
                    <div className="pt-10 md:pt-[88px]">
                        <h4 className="font-DanaMedium text-2xl text-white pb-6 md:pb-7">دسترسی سریع</h4>
                        <div className="flex gap-x-10 md:gap-x-[60px]">
                            <div className="flex flex-col text-start gap-y-2.5 md:gap-y-5">
                                <div className="flex flex-row items-center gap-x-2 md:gap-x-3">
                                    <div className={`border w-2 md:w-2.5 h-1 rounded-3xl ${activeLink === "حریم خصوصی" ? "bg-orange-300 border-orange-300" : "bg-white"}`}/>
                                    <li className="font-DanaLight text-base md:text-xl list-none">
                                        <a
                                            className={activeLink === "حریم خصوصی" ? "text-orange-300" : "text-gray-300"}
                                            onClick={(e) => {
                                                e.preventDefault();
                                                setActiveLink("حریم خصوصی");
                                            }}
                                            href="#">حریم خصوصی</a>
                                    </li>
                                </div>
                                <div className="flex flex-row items-center gap-x-2 md:gap-x-3">
                                    <div className={`border w-2 md:w-2.5 h-1 rounded-3xl ${activeLink === "عودت کالا" ? "bg-orange-300 border-orange-300" : "bg-white"}`}/>
                                    <li className="font-DanaLight text-base md:text-xl list-none">
                                        <a
                                            className={activeLink === "عودت کالا" ? "text-orange-300" : "text-gray-300"}
                                            onClick={(e) =>{
                                                e.preventDefault();
                                                setActiveLink("عودت کالا")
                                            }}
                                            href="#">عودت کالا</a>
                                    </li>
                                </div>
                                <div className="flex flex-row items-center gap-x-2 md:gap-x-3">
                                    <div className={`border w-2 md:w-2.5 h-1 rounded-3xl ${activeLink === "شرایط استفاده" ? "bg-orange-300 border-orange-300" : "bg-white"}`}/>
                                    <li className="font-DanaLight text-base md:text-xl list-none">
                                        <a
                                            className={activeLink === "شرایط استفاده" ? "text-orange-300" : "text-gray-300"}
                                            onClick={(e) =>{
                                                setActiveLink("شرایط استفاده");
                                                e.preventDefault();
                                            }}
                                            href="#">شرایط استفاده</a>
                                    </li>
                                </div>
                                <div className="flex flex-row items-center gap-x-2 md:gap-x-3">
                                    <div className={`border w-2 md:w-2.5 h-1 rounded-3xl ${activeLink === "ثبت سفارش" ? "bg-orange-300 border-orange-300" : "bg-white"}`}/>
                                    <li className="font-DanaLight text-base md:text-xl list-none">
                                        <a
                                            className={activeLink === "ثبت سفارش" ? "text-orange-300" : "text-gray-300"}
                                            onClick={(e) =>{
                                                setActiveLink("ثبت سفارش");
                                                e.preventDefault();
                                            }}
                                            href="#">ثبت سفارش</a>
                                    </li>
                            ...
                            <div className="flex flex-col text-start gap-y-2.5 md:gap-y-5">
                                <div className="flex flex-row items-center gap-x-2 md:gap-x-3">
                                    <div className={`border w-2 md:w-2.5 h-1 rounded-3xl ${activeLink === "پرسش های متداول" ? "bg-orange-300 border-orange-300" : "bg-white"}`}/>
                                    <li className="font-DanaLight text-base md:text-xl list-none">
                                        <a
                                            className={activeLink === "پرسش های متداول" ? "text-orange-300" : "text-gray-300"}
                                            onClick={(e) => {
                                                setActiveLink("پرسش های متداول");
                                                e.preventDefault();
                                            }}
                                            href="#">پرسش های متداول</a>
                                    </li>
                                </div>
                                <div className="flex flex-row items-center gap-x-2 md:gap-x-3">
                                    <div className={`border w-2 md:w-2.5 h-1 rounded-3xl ${activeLink === "فرصت های شغلی" ? "bg-orange-300 border-orange-300" : "bg-white"}`}/>
                                    <li className="font-DanaLight text-base md:text-xl list-none">
                                        <a
                                            className={activeLink === "فرصت های شغلی" ? "text-orange-300" : "text-gray-300"}
                                            onClick={(e) =>{
                                                 e.preventDefault();
                                                 setActiveLink("فرصت های شغلی")
                                            }}
                                            href="#">فرصت های شغلی</a>
                                    </li>
                                </div>
                                <div className="flex flex-row items-center gap-x-2 md:gap-x-3">
                                    <div className={`border w-2 md:w-2.5 h-1 rounded-3xl ${activeLink === "ضمانت نامه ها" ? "bg-orange-300 border-orange-300" : "bg-white"}`}/>
                                    <li className="font-DanaLight text-base md:text-xl list-none">
                                        <a
                                            className={activeLink === "ضمانت نامه ها" ? "text-orange-300" : "text-gray-300"}
                                            onClick={(e) =>{
                                                 e.preventDefault();
                                                 setActiveLink("ضمانت نامه ها")
                                            }}
                                            href="#">ضمانت نامه ها</a>
                                    </li>
                                </div>
                                <div className="flex flex-row items-center gap-x-2 md:gap-x-3">
                                    <div className={`border w-2 md:w-2.5 h-1 rounded-3xl ${activeLink === "ارتباط با ما" ? "bg-orange-300 border-orange-300" : "bg-white"}`}/>
                                    <li className="font-DanaLight text-base md:text-xl list-none">
                                        <a
                                            className={activeLink === "ارتباط با ما" ? "text-orange-300" : "text-gray-300"}
                                            onClick={(e) =>{
                                                 e.preventDefault();
                                                 setActiveLink("ارتباط با ما")
                                            }}
                                            href="#">ارتباط با ما</a>
                                    </li>
                                </div>
                    ...
                    <div className="pt-10 md:pt-[88px]">
                        <div className="md:w-[509px]">
                            <h4 className="text-2xl text-white pb-6 md:pb-7">در تماس باشیم</h4>
                            {/*آدرس*/}
                            <div className="flex items-center md:gap-x-3">
                                ...
                                <span className="font-DanaLight text-base md:text-xl text-gray-300 leading-6 md:leading-7">بلوار میرداماد، خیابان البرز، کوچه قبادیان شرقی، پلاک ۳۳</span>
                            </div>
                            {/*شماره تماس و ایمیل*/}
                            <div className="flex flex-col md:flex-row  md:gap-x-5 pt-4 md:pt-5">
                                <div className="flex flex-row items-center gap-x-2 md:gap-x-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5 md:size-6 text-gray-300 md:-translate-y-1">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                                    </svg>
                                    <span className="font-DanaMedium text-base md:text-xl text-gray-300">info@Coffee.com</span>
                                </div>
                                <div className="flex items-center gap-x-5 pt-4 md:pt-0">
                                    <div className="flex flex-row items-center gap-x-2 md:gap-x-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5 md:size-6 text-gray-300 md:-translate-y-1">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z" />
                                        </svg>
                                        <span className="font-DanaMedium md:text-xl text-gray-300">6628 123 0902</span>
                                    </div>
                                    <span className="font-DanaMedium md:text-xl text-gray-300">6789012 - 021</span>
                                </div>
                            </div>
                            {/*شبکه های اجتماعی*/}
                            <div className="flex items-center gap-x-1.5 md:gap-x-6 pt-6 md:pt-10">
                                <div className="flex items-center justify-center w-44 md:w-[248px] h-12 border border-orange-200 rounded-xl gap-x-2 ">
                                    <svg viewBox="0 0 39 38" fill="none" xmlns="http://www.w3.org/2000/svg" className="md:w-[38px] md:h-[38px] w-[26px] h-[26px]">
                                        <path d="M13.7405 5.9375C9.52393 5.9375 6.05884 9.39795 6.05884 13.6191V24.3809C6.05884 28.5974 9.51929 32.0625 13.7405 32.0625H24.5022C28.7188 32.0625 32.1838 28.6021 32.1838 24.3809V13.6191C32.1838 9.40259 28.7234 5.9375 24.5022 5.9375H13.7405ZM13.7405 8.3125H24.5022C27.4385 8.3125 29.8088 10.6829 29.8088 13.6191V24.3809C29.8088 27.3171 27.4385 29.6875 24.5022 29.6875H13.7405C10.8042 29.6875 8.43384 27.3171 8.43384 24.3809V13.6191C8.43384 10.6829 10.8042 8.3125 13.7405 8.3125ZM26.135 10.9102C25.5366 10.9102 25.0588 11.3879 25.0588 11.9863C25.0588 12.5847 25.5366 13.0625 26.135 13.0625C26.7334 13.0625 27.2112 12.5847 27.2112 11.9863C27.2112 11.3879 26.7334 10.9102 26.135 10.9102ZM19.1213 11.875C15.2017 11.875 11.9963 15.0803 11.9963 19C11.9963 22.9197 15.2017 26.125 19.1213 26.125C23.041 26.125 26.2463 22.9197 26.2463 19C26.2463 15.0803 23.041 11.875 19.1213 11.875ZM19.1213 14.25C21.7607 14.25 23.8713 16.3606 23.8713 19C23.8713 21.6394 21.7607 23.75 19.1213 23.75C16.4819 23.75 14.3713 21.6394 14.3713 19C14.3713 16.3606 16.4819 14.25 19.1213 14.25Z" fill="#FED7AA"/>
                                    </svg>
                                    <span className="text-orange-200 md:text-xl">golden_coffee@</span>
                                </div>
                                <div className="flex items-center justify-center w-44 md:w-[248px] h-12 border border-orange-200 rounded-xl gap-x-2 bg-gradient-to-l from-orange-300 to-orange-200">
                                    <svg viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg" className="md:w-[38px] md:h-[38px] w-[26px] h-[26px]">
                                    ...
                                    <span className=" text-zinc-700 md:text-xl">golden_coffee@</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                {/*Copy Right*/}
                <div className="flex md:flex-row flex-col justify-between gap-y-4 mt-10 md:mt-11 pt-10 md:pt-11 md:pb-12 border-t border-white/10">
                    <div className="flex items-center gap-x-2.5">
                        ...
                        <div>
                            <span className="text-gray-300 text-xs md:text-base">تمام حقوق این رابط کاربری متعلق به </span>
                            <a href="https://nasix.ir/" className="text-orange-200 text-xs md:text-base">ناسیکس </a>
                            <span className="text-gray-300 text-xs md:text-base">میباشد و هیچ فردی اجازه استفاده آن را در مصارف شخصی و تجاری ندارد.</span>
                        </div>
                    </div>
                    <span className="text-gray-300 text-xs md:text-base text-left">.Copyright © 2023 Golden Coffee. All rights reserved</span>
                </div>
            </div>
        </div>
    )}
