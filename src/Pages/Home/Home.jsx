    ...
    return (
        <div className="font-DanaLight bg-gray-100 dark:bg-zinc-800">
            ...
            <div className="container relative mb-20" >
                ...
                {/*Coffee Club*/}
                <div className="flex flex-col md:flex-row flex-wrap lg:flex-nowrap justify-center md:justify-between items-center h-[254px] lg:gap-x-9 lg:h-36 rounded-2xl mt-8 md:mt-20 bg-gradient-to-l from-emerald-600 to-emerald-500">
                    <div className="flex justify-between items-center pt-[23px] mb-[34px] gap-x-3 md:gap-x-6 lg:gap-x-3">
                        <img className="w-[110px] h-[98px] mr-3 md:mr-11 lg:mr-5" src="/assets/images/club/diamond.png" alt="club-image"/>
                        <div className="flex flex-col justify-center gap-x-3 gap-y-2">
                            <h4 className="font-MorabaMedium text-2xl md:text-5xl lg:text-4xl lg:text-nowrap text-white">کافی کلاب</h4>
                            <span className="font-MorabaLight text-lg md:text-2xl lg:text-lg lg:text-nowrap text-white md:max-w-[400px] max-w-[235px]">میدونستی میتونی با امتیاز هات قهوه بگیری ؟</span>
                        </div>
                    </div>
                    <div className="flex justify-center md:justify-between items-center gap-x-[19px] md:gap-x-[110px] lg:gap-x-14 md:px-24">
